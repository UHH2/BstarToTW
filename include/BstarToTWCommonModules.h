...
class JEC2018Module: public uhh2::AnalysisModule {
 ...
 private:
  ...
  std::unique_ptr<HOTVRJetCorrector> jec_hotvr_mc, jec_hotvr_A, jec_hotvr_B, jec_hotvr_C, jec_hotvr_D;
  std::unique_ptr<AnalysisModule> jlc_hotvr;
  std::unique_ptr<JetResolutionSmearer> jet_resolution_smearer;
  ...
  const int runnr_B = 319310;
  const int runnr_C = 320065;
  const int runnr_D = 325175;
};
