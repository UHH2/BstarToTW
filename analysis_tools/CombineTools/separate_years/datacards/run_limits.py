...
def run_combine(signal_dir, signals, max_jobs):
    ...
    for signal in signals:
        ...
        # command = "nice -n {} combine {}/datacard_{}.txt -M AsymptoticLimits -n {} -t 100 --cminDefaultMinimizerStrategy 0 --toysFrequentist --bypassFrequentistFit  --rMin -10 --rMax 20 --run blind".format(10, signal_dir, signal, signal) # --cminDefaultMinimizerTolerance 0
        command = "nice -n {} combine {}/datacard_{}.txt -M AsymptoticLimits -n {} --rMin -2 --rMax 10".format(10, signal_dir, signal, signal) # --cminDefaultMinimizerTolerance 0
        # command = "nice -n {} combine {}/datacard_{}.txt -M HybridNew --LHCmode LHC-limits --rMin -2 --rMax 2 -n {}".format(10, signal_dir, signal, signal)
